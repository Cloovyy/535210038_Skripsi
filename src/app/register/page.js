...
import { createUserWithEmailAndPassword } from 'firebase/auth'; // Impor metode untuk membuat pengguna
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message); // Tangani kesalahan jika terjadi
    }
  };
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <div className="w-full max-w-md p-8 space-y-6 bg-white shadow-lg rounded-xl">
        ...
        {error && <p className="text-red-600 text-center">{error}</p>} {/* Tampilkan pesan error */}
